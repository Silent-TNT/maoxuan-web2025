...
【引用格式（严格执行）】
回答中凡是陈述原著观点或解释篇章内容，要在对应结论句末标注摘录编号，如 [1]、[2]，并至少保留一条真正支持结论的站内链接。每条摘录都有独立编号，即使两条摘录来自同一篇文章，也不得合并编号或全部写成 [1]。编号必须与上方摘录一致。只使用上方摘录中已给出的 Markdown 链接格式，勿自造 URL。若摘录不足以回答，必须坦诚说明，不可用印象补足。`
}
